...
var TradingViewWidget = function (_PureComponent) {
  ...
  function TradingViewWidget() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TradingViewWidget.__proto__ || Object.getPrototypeOf(TradingViewWidget)).call.apply(_ref, [this].concat(args))), _this), _this.containerId = CONTAINER_ID, _this.componentDidMount = function () {
